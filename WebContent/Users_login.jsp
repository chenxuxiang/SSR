...
<%@ taglib prefix="s" uri="/struts-tags"%><!-- 加载struits的标签库 -->
<%
...
<body>
	<div id="wrapper">
			...
			<div id="mainBg">
				<div id="mainPanel">
					...
					<div id="right">
						...
						<form name="loginForm" action="<%=path%>/users/Users_login.action"
							method="post">
							<!-- start of login form -->
							<div id="welcome">
								<span id="welcome-text">S&nbsp;R&nbsp;S&nbsp;登&nbsp;录</span>
							</div>
							<div id="user-name">
		...
		<div id="footer">
			<div id="text">Copyright © 2009-2015 All Rights Reserved
				Powered By Simoniu</div>
		</div>
	</div>
</body>
</html>