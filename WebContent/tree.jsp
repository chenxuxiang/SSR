...
var treeMenu = [
	{ level:1, name:"课程管理"},
	{ level:2, name:"查看课程",ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"修改信息", ico:"images/icon_default.gif",link:"students/Students_query.action"},
